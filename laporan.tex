...
Berdasarkan hasil pengujian beban bertingkat (1, 3, dan 5 client konkuren), throughput maksimal sebelum terjadi degradasi performa signifikan (peningkatan RTT $>2\times$) diestimasikan sebesar \textbf{45 requests/detik} dengan jumlah thread aktif sebanyak \textbf{12} pada proxy.
